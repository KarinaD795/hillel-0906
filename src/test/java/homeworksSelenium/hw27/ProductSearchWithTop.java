package homeworksSelenium.hw27;
...
public class ProductSearchWithTop {
    WebDriver driver;
    ...
    public void searchProductWithTop() throws InterruptedException {
        ...
        WebElement laptopsAndComputers = driver.findElement(By.xpath("//rz-fat-menu//a[contains(text(),'Ноутбуки и компьютеры')]"));
